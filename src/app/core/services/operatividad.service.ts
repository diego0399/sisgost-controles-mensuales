...
/** Semáforo institucional de una Dirección/Unidad. */
...
/** Indicadores de operatividad de una Dirección/Unidad en un período. */
export interface KpiDireccion {
  direccion: string;
  unidad: string;
  /** Nombre institucional de la Dirección. */
  nombre: string;
  corta: string;
...
/**
 * Operatividad por Dirección/Unidad: el cálculo que alimenta la vista ejecutiva de Controles
...
export class OperatividadService {
  ...
  /** Controles del período que aplican a la Dirección/Unidad (los que el catálogo programa ahí). */
  ...
  /** Indicadores de una Dirección/Unidad en un período. */
  ...
  /**
   * Indicadores de todas las Direcciones/Unidades visibles para el usuario, con los filtros
  ...
  /** Operatividad mes a mes de una Dirección/Unidad (historial anual). */
  ...
  /** Carga por Técnico de Soporte: Direcciones/Unidades atendidas y controles abiertos. */
